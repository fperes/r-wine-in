...
# 6. Análise multivariada (Gosto / $taste)
...
#### Variável dependente: gosto / *$taste*
...
## Conclusão:
O melhor modelo para classificar esta base foi o **Random Forest**, seguido de perto pelo **Bagging CART**. 
...
<ul>
  ...
  <li>fazer calculos de ganho de informação e ranquear os atributos</li>
  <li>Etc.</li>
</ul>